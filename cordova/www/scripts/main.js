...
define('modules/notificationSounds',[
	'underscore'
	], function (_) {
	return {
		sounds: [
...
this["JST"]["app/scripts/templates/container.ejs"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div id="navContainer"></div>\n<div id="container"></div>\n';

}
return __p
};

this["JST"]["app/scripts/templates/homeCurrentTemperature.ejs"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
__p += '<div class="panel">\n\t<h3 class="panelTitle left"><i class="icon icon-beaker panelTitle--icon"></i>Current temperature</h3>\n\t<h3 class="panelTitle right">Desired: ' +
((__t = ( desired )) == null ? '' : __t) +
' &#186;C</h3>\n\t';
 if (current === null) { ;
__p += '\n\t\t<p class="currentTemp currentTemp-ok">--</p>\n\t';
 } else { ;
__p += '\n\t\t<p class="currentTemp currentTemp-' +
((__t = ( status )) == null ? '' : __t) +
'">' +
...
function print() { __p += __j.call(arguments, '') }
with (obj) {
__p += '<div class="panel">\n\t<h3 class="panelTitle"><i class="icon icon-bar-chart panelTitle--icon"></i>';
 if (historyTimestamp) { ;
__p += '\n\t\tLast temperature reading at ' +
((__t = ( historyTimestamp )) == null ? '' : __t) +
'\n\t\t';
 } else { ;
__p += '\n\t\tThere\'s no temperature history yet\n\t\t';
 } ;
__p += '</h3>\n\t<canvas id="canvas" style="height: 300px; width: 100%; margin-top: 20px;"></canvas>\n</div>\n';

}
return __p
};

this["JST"]["app/scripts/templates/homeTimer.ejs"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
__p += '<div class="panel">\n\t<h3 class="panelTitle left"><i class="icon icon-time panelTitle--icon"></i>Next timer</h3>\n\t<h3 class="panelTitle right">' +
((__t = ( nextTimerLabel )) == null ? '' : __t) +
' (' +
((__t = ( nextTimerStartValue )) == null ? '' : __t) +
':00)</h3>\n\t<p class="nextTime">' +
((__t = ( timeToNextTimer )) == null ? '' : __t) +
'</p>\n\t<button type="submit" class="js-toggle-timer"><i class="icon icon-';
 if (active) { ;
__p += 'pause';
 } else { ;
__p += 'play';
...
this["JST"]["app/scripts/templates/popup.ejs"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="overlay overlay-popup"></div>\n<div class="popup" style="display: none;">\n\t<h1 class="popup--title">' +
((__t = ( title )) == null ? '' : __t) +
'</h1>\n\t<div class="popup--inset">\n\t\t<p class="popup--message">' +
((__t = ( message )) == null ? '' : __t) +
'</p>\n\t</div>\n\t<div class="popup--buttons">\n\t\t<button class="popup--button popup--button-ok js-popupOk">Ok</button>\n\t\t<button class="popup--button popup--button-cancel js-popupCancel">Cancel</button>\n\t</div>\n</div>\n';
...
function print() { __p += __j.call(arguments, '') }
with (obj) {
__p += '<div class="panel">\n\t<h3 class="panelTitle"><i class="icon icon-volume-up panelTitle--icon"></i>Notification settings</h3>\n\t<div class="form">\n\t\t<label class="label">Notification sound</label>\n\t\t<div class="selectContainer">\n\t\t\t<select data-property="notification" class="select">\n\t\t\t\t';
 for(var i=0;i<sounds.length;i++) {
							var sound = sounds[i]; ;
__p += '\n\t\t\t\t\t<option value="' +
((__t = ( sound.id )) == null ? '' : __t) +
'" ';
 if (sound.id == notification) { ;
__p += ' selected="true" ';
 } ;
__p += '>' +
((__t = ( sound.name )) == null ? '' : __t) +
'</option>\n\t\t\t\t';
 } ;
__p += '\n\t\t\t</select>\n\t\t</div>\n\n\t\t<label class="label">SMS number</label>\n\t\t<input data-property="sms" class="input" type="number" value="' +
((__t = ( sms )) == null ? '' : __t) +
'" />\n\n\t\t';
 if (devices && devices.length) { ;
__p += '\n\t\t\t<label class="label">Temperature reader</label>\n\t\t\t<select data-property="device" class="select">\n\t\t\t';
 devices.forEach(function(d) { ;
__p += '\n\t\t\t\t<option value="' +
((__t = ( d.address )) == null ? '' : __t) +
'" ';
 if (d.address == device) { ;
__p += ' selected="true" ';
 } ;
...
this["JST"]["app/scripts/templates/temperatureDetails.ejs"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
__p += '<div class="panel">\n\t<h3 class="panelTitle left"><i class="icon icon-temperature panelTitle--icon"></i>Current temperature</h3>\n\t<h3 class="panelTitle right">Desired: ' +
((__t = ( desired )) == null ? '' : __t) +
' &#186;C</h3>\n\t';
 if (current === null) { ;
__p += '\n\t\t<p class="currentTemp currentTemp-ok">--</p>\n\t';
...
this["JST"]["app/scripts/templates/temperatureSettings.ejs"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
__p += '<div class="panel">\n\t<h3 class="panelTitle"><i class="icon icon-settings panelTitle--icon"></i>Settings</h3>\n\t<div class="form">\n\t\t<label class="label">Desired temp (&#186;C)</label>\n\t\t<input data-property="desired" class="input temperatureDesiredInput" type="number" value="' +
((__t = ( desired )) == null ? '' : __t) +
'" />\n\n\t\t<label class="label">Offset allowance (&#186;C)</label>\n\t\t<input data-property="offsetAllowance" class="input temperatureOffsetInput" type="number" value="' +
((__t = ( offsetAllowance )) == null ? '' : __t) +
'" />\n\n\t\t<label class="checkbox timer--checkbox">\n\t\t\t<input type="checkbox" class="temperatureNotificationInput" ';
 if (notification) { ;
__p += 'checked="checked"';
 };
__p += '><i class="icon icon-volume-up checkbox--icon"></i>Play sound\n\t\t</label>\n\t\t<label class="checkbox timer--checkbox">\n\t\t\t<input type="checkbox" class="temperatureSMSInput" ';
 if (sms) { ;
__p += 'checked="checked"';
 };
__p += '><i class="icon icon-comment checkbox--icon"></i>Send text\n\t\t</label>\n\t</div>\n</div>\n';
 if (notificationSent) { ;
__p += '\n\t<div class="panel">\n\t\t<h3 class="panelTitle"><i class="icon icon-temperature panelTitle--icon"></i>A temperature notification has been sent</h3>\n\t\t<p>Check below if you want to be notified the next time the desired temp has been reached</p>\n\t\t<label class="checkbox timer--checkbox">\n\t\t\t<input type="checkbox" class="js-sendNotification" ';
 if (!notificationSent) { ;
__p += 'checked="checked"';
 };
__p += '><i class="icon icon-comment checkbox--icon"></i>Notify me again\n\t\t</label>\n\t</div>\n';
 } ;
__p += '\n';
...
this["JST"]["app/scripts/templates/timer.ejs"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
...
__p += '\n\t<div class="panel">\n\t\t<div class="timer" data-id="' +
((__t = ( currentTimer.get('id') )) == null ? '' : __t) +
'">\n\t\t\t<div class="clearfix">\n\t\t\t\t<h1 class="timerTitle left js-starttime">' +
((__t = ( currentTimer.get('startValue') )) == null ? '' : __t) +
':00</h1>\n\t\t\t\t<label class="toggle right">\n\t\t\t\t\t<input type="checkbox" class="timerActiveInput" ';
 if (currentTimer.get('active')) { ;
__p += 'checked="checked"';
 };
__p += '>\n\t\t\t\t\t<span data-unchecked="Off" data-checked="On"></span>\n\t\t\t\t</label>\n\t\t\t</div>\n\t\t\t<div class="timerLabel">\n\t\t\t\t<i class="js-deleteTimer icon icon-trash timerLabel--icon-trash right"></i>\n\t\t\t\t<div class="timerSettings js-timerSettingsClosed" ';
 if (currentTimer.get('uiOpen')) { ;
__p += 'style="height: 0px;"';
 } ;
__p += '>\n\t\t\t\t\t<div class="js-toggleTimerSettings">\n\t\t\t\t\t\t<i class="icon icon-angle-down timerLabel--icon"></i>\n\t\t\t\t\t\t<span class="timerLabel--label">' +
((__t = ( currentTimer.get('label') )) == null ? '' : __t) +
'<span>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class="timerSettings js-timerSettingsOpen" ';
 if (!currentTimer.get('uiOpen')) { ;
__p += 'style="height: 0px;"';
 } ;
__p += '>\n\t\t\t\t\t<div>\n\t\t\t\t\t\t<div class="js-toggleTimerSettings">\n\t\t\t\t\t\t\t<i class="icon icon-angle-up timerLabel--icon"></i>\n\t\t\t\t\t\t\t<label class="label">Label</label>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<input type="text" class="input timerLabelInput" value="' +
((__t = ( currentTimer.get('label') )) == null ? '' : __t) +
'" />\n\n\t\t\t\t\t\t<label class="label">Time (minutes)</label>\n\t\t\t\t\t\t<input type="text" class="input timerStartValueInput" value="' +
((__t = ( currentTimer.get('startValue') )) == null ? '' : __t) +
'" />\n\n\t\t\t\t\t\t<label class="checkbox timer--checkbox">\n\t\t\t\t\t\t\t<input type="checkbox" class="timerNotificationInput" ';
 if (currentTimer.get('notification')) { ;
__p += 'checked="checked"';
 };
__p += '><i class="icon icon-volume-up checkbox--icon"></i>Play sound\n\t\t\t\t\t\t</label>\n\t\t\t\t\t\t<label class="checkbox timer--checkbox">\n\t\t\t\t\t\t\t<input type="checkbox" class="timerSMSInput" ';
 if (currentTimer.get('sms')) { ;
__p += 'checked="checked"';
 };
__p += '><i class="icon icon-comment checkbox--icon"></i>Send text\n\t\t\t\t\t\t</label>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n';
 } ;
__p += '\n<button type="submit" class="js-addNewTimer">Add new timer</button>\n';

}
return __p
};

this["JST"]["app/scripts/templates/titleBar.ejs"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="titleBar titleBar-' +
((__t = ( title )) == null ? '' : __t) +
'">\n\t<i class="icon icon-reorder menuIcon js-toggle-menu"></i>\n\t<h1 class="pageTitle"><i class="icon icon-' +
((__t = ( title )) == null ? '' : __t) +
' pageTitle-icon"></i>' +
((__t = ( title )) == null ? '' : __t) +
'</h1>\n</div>\n';
